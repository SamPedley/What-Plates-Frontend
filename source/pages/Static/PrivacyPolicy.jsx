...
// Privacy Policy Copy was copypasted with minor tweaks from
// https://www.bbb.org/greater-san-francisco/for-businesses/toolkits1/sample-privacy-policy/
const PrivacyPolicy = () => (
  <section className={s.container}>
    <h1>What Plates Privacy Policy</h1>

    <p>This privacy notice discloses the privacy practices for whatplates.com. This privacy notice applies solely to information collected by this website. It will notify you of the following:</p>
    <ol>
    ...
    <p>You may opt out of any future contacts from us at any time. You can do the following at any time by contacting us via info@whtplates.com:</p>
    <ul>
